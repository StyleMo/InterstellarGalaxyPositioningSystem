...
If you think these standardizations are made up, just watch the news. Regardless, the final project WILL meet all of the functional requirements, and the standardizations above could be changed to match that. In fact, they could simply be Earth-level standardizations and it would be similar to a Sea GPS, but that already exists, this doesn’t. 
